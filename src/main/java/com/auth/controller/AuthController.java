...
//		this.template.convertAndSend("/topic/greetings/" + sha256, noticeMessage);
	 ...
	 */
	@CrossOrigin("*")
	@GetMapping("/nice/success")
	public String successGet(HttpServletRequest request, Model model) {
...
//		this.template.convertAndSend("/topic/greetings/" + sha256, noticeMessage);
	 ...
	 */
	@CrossOrigin("*")
	@GetMapping("/nice/fail")
	public String failGet(HttpServletRequest request) {
		NiceID.Check.CPClient niceCheck = new NiceID.Check.CPClient();
